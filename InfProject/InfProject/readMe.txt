https://webcompact.wdm.ruhr-uni-bochum.de/

Form Verification:
https://docs.fluentvalidation.net/en/latest/
Client Form Verification (with FluentValidation):
https://github.com/sinanbozkus/FormHelper

Drag & Drop:
https://medium.com/geekculture/web-based-multi-screen-apps-including-drag-drop-5e161da6507b
